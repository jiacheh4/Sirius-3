...
<br>
We also tried in the 10 x 10 map, the agent is able to consecutively kill the zombie approximately at 1400 round. The training took about 10 hours and the data is very long so I didn't show it here.
